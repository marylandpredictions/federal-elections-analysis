...
import { houseIncumbents } from '../components/swingometer/houseIncumbents';
...
const housePercentages = {
  ...
  'MO-2':{d:77.7,r:22.3},'MO-3':{d:44.6,r:55.4},'MO-4':{d:36.3,r:63.7},'MO-5':{d:28.8,r:71.2},'MO-6':{d:62.2,r:37.8},'MO-7':{d:28.5,r:71.5},'MO-8':{d:23,r:77},
...
const houseRows = [...rawSeats]
  ...
  .map(([key, rating]) => {
    const pct = housePercentages[key];
    return {
      state: key,
    ...
    <div className="min-h-[calc(100vh-4rem)] px-4 py-16 sm:py-24 bg-background">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
          ...
          <ForecastRaceTable rows={houseRows} title="All House Races" showPcts={true} stateLabel="District" />
        </motion.div>
      </div>
    </div>
  );
