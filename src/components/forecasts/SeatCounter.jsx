...
export default function SeatCounter({ ratings }) {
  ...
  return (
    <div className="flex justify-center gap-4 mb-6 flex-wrap">
      <div className="bg-blue-600 rounded-xl px-6 py-3 shadow-lg">
      ...
      <div className="bg-purple-600 rounded-xl px-6 py-3 shadow-lg">
      ...
      <div className="bg-red-600 rounded-xl px-6 py-3 shadow-lg">
